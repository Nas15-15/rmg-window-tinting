...
- Name: booking.spec.js >> Window Tint Booking Form E2E Tests >> should render the booking form initial state correctly
- Location: tests\booking.spec.js:38:3
...
Locator: locator('text=DIY Pre-Cut Kit')
Expected: visible
Error: strict mode violation: locator('text=DIY Pre-Cut Kit') resolved to 2 elements:
