...
- Name: booking.spec.js >> Window Tint Booking Form E2E Tests >> should calculate custom prices for window selections and add-ons
- Location: tests\booking.spec.js:70:3
      ...
      - generic [ref=e69]:
        ...
        - generic [ref=e79]:
          ...
          - generic [ref=e135]:
            ...
            - generic [ref=e139]:
              - generic [ref=e140]: "LED Headlights:"
              - generic [ref=e141]: $100
            - generic [ref=e142]:
              - generic [ref=e143]: "Estimated Total:"
              - generic [ref=e144]: $530
            - generic [ref=e145]:
              - button "Request Booking" [ref=e146] [cursor=pointer]
              - paragraph [ref=e147]: No payment required to book. You pay when the work is done.
  - link "Chat on WhatsApp" [ref=e148] [cursor=pointer]:
    - /url: https://wa.me/message/XVZHW73N4VLTF1
    - img [ref=e149]
  - contentinfo [ref=e151]:
    - generic [ref=e152]: 2507 E 18th St, Lehigh Acres, FL | (305) 457-5144
    - generic [ref=e153]: © 2026 RMG Window Tinting. All rights reserved.
    - generic [ref=e154]:
      - text: Made by
      - link "Nas" [ref=e155] [cursor=pointer]:
...
```ts
  ...
  2   | 
  3   | test.describe('Window Tint Booking Form E2E Tests', () => {
  4   |   
  5   |   test.beforeEach(async ({ page }) => {
  6   |     // Intercept API calls to ensure speed and isolation from external services (like NHTSA)
  7   |     await page.route('**/api/carmakes', async (route) => {
  8   |       await route.fulfill({
  9   |         status: 200,
  10  |         contentType: 'application/json',
  11  |         body: JSON.stringify(['Honda', 'Toyota', 'Ford']),
  12  |       });
  13  |     });
  14  | 
  15  |     await page.route('**/api/carmodels*', async (route) => {
  16  |       const url = new URL(route.request().url());
  17  |       const make = url.searchParams.get('make');
  18  |       const year = url.searchParams.get('year');
  19  |       
  20  |       if (make === 'Honda' && year === '2023') {
  21  |         await route.fulfill({
  22  |           status: 200,
  23  |           contentType: 'application/json',
  24  |           body: JSON.stringify([{ model: 'Civic' }, { model: 'Accord' }]),
  25  |         });
  26  |       } else {
